...
const Fotter = () => {
  ...
  return (
    // Final Changes
    <footer className="w-full py-10 px-4 sm:px-6 lg:px-8 footer-bg-effect footer-glass">
      {/* footer links */}
          ...
          <div className="sm:flex sm:justify-between sm:items-center">
            ...
            <div className="flex items-center gap-x-3">
              ...
              <div className="relative inline-flex">
                ...
                {isLangOpen && (
                  <ul className="absolute bottom-full left-0 mb-2 z-10 w-48 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded shadow-md text-sm text-gray-700 dark:text-gray-200">
                    {languages.map((lang) => (
                      <li key={lang}>
                        <a
                          href="#"
